-- Create the database
DROP DATABASE IF EXISTS human_resource_db;
...
DROP TABLE IF EXISTS human_resource.employee_projects CASCADE;
DROP TABLE IF EXISTS human_resource.attendance CASCADE;
DROP TABLE IF EXISTS human_resource.salaries CASCADE;
DROP TABLE IF EXISTS human_resource.projects CASCADE;
DROP TABLE IF EXISTS human_resource.employees CASCADE;
DROP TABLE IF EXISTS human_resource.departments CASCADE;
...
CREATE TABLE human_resource.salaries (
    emp_id INT,
    salary INT,
    pay_date DATE
);
...
CREATE TABLE human_resource.projects (
...
CREATE TABLE human_resource.employee_projects (emp_id INT, project_id INT);

INSERT INTO
    human_resource.employee_projects
VALUES
    (101, 10),
    (101, 11),
    (102, 11),
...
CREATE TABLE human_resource.attendance (
